---https://github.com/OXY2DEV/nvim/blob/main/lua/scripts/lsp_hover.lua
...
hover.hover = function(window)
  ...
  vim.lsp.buf_request(buf, "textDocument/hover", position_params, function(err, result, ctx, config)
    ...
    H = math.max(1, math.min(vim.api.nvim_win_text_height(hover.window, { start_row = 0, end_row = -1 }).all, H, math.floor(vim.o.lines * 0.5)))
